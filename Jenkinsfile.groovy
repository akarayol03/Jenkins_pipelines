node {
    ...
    ['golden_ami', 'tower', 'elk', 'nagiosxi', 'gitlab', 'nexus', 'vault'], description: 'What tool would you like to build?', name: 'TOOL_TO_PROVISION'), 
    ...
    stage ("Send Notification to Slack"){
        slackSend channel: 'nagios-alerts', message: "${TOOL_TO_PROVISION} has been built"
    }
    stage ("Send Email"){
        mail bcc: '', 
        ...
        from: '', 
        replyTo: '', 
        subject: "${TOOL_TO_PROVISION} has been built", to: 'ahmetk@gmail.com'
    }
}
